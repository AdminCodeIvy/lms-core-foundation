...
import { adminService, District, SubDistrict, PropertyType, Carrier, Country } from '@/services/adminService';
...
const LookupManagement = () => {
  ...
  const fetchSubDistricts = async () => {
    try {
      const data = await adminService.getSubDistricts();
  ...
  const fetchPropertyTypes = async () => {
    try {
      const data = await adminService.getPropertyTypes();
  ...
  const handleSaveDistrict = async () => {
    try {
      ...
      if (districtForm.id) {
        await adminService.updateDistrict(districtForm.id, {
          code: districtForm.code,
          name: districtForm.name,
          is_active: districtForm.is_active
        });
      } else {
  ...
  const handleToggleDistrictStatus = async (district: District) => {
    try {
      await adminService.toggleDistrictStatus(district.id, !district.is_active);
  ...
  const handleSaveSubDistrict = async () => {
    try {
      ...
      if (subDistrictForm.id) {
        await adminService.updateSubDistrict(subDistrictForm.id, {
          district_id: subDistrictForm.district_id,
          name: subDistrictForm.name,
          is_active: subDistrictForm.is_active
        });
      } else {
        await adminService.createSubDistrict({
          district_id: subDistrictForm.district_id,
          name: subDistrictForm.name,
          is_active: subDistrictForm.is_active
        });
  ...
  const handleSavePropertyType = async () => {
    try {
      ...
      if (propertyTypeForm.id) {
        await adminService.updatePropertyType(propertyTypeForm.id, {
          name: propertyTypeForm.name,
          category: propertyTypeForm.category,
          is_active: propertyTypeForm.is_active
        });
      } else {
        await adminService.createPropertyType({
          name: propertyTypeForm.name,
          category: propertyTypeForm.category,
          is_active: propertyTypeForm.is_active
        });
  ...
  const handleSaveCarrier = async () => {
    try {
      ...
      if (carrierForm.id) {
        await adminService.updateCarrier(carrierForm.id, {
          name: carrierForm.name,
          is_active: carrierForm.is_active
        });
      } else {
        await adminService.createCarrier({
          name: carrierForm.name,
          is_active: carrierForm.is_active
        });
      }
  ...
  const handleSaveCountry = async () => {
    try {
      ...
      if (countryForm.id) {
        await adminService.updateCountry(countryForm.id, {
